# -*- coding: utf-8 -*-
"""phil_mccormick_homework1

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ABAM4tpipYqP7nyk_1i0vFNOmCEQNjsw
...
#1
print("What are the mean, min, and max temperatures of Paris?")
print(np.mean(august_temps, axis=1)[0])
print(np.min(august_temps, axis=1)[0])
print(np.max(august_temps, axis=1)[0])

#2
print("What is the minimum and maximum temperature in Europe (from the 7 cities provided) for the month of August?")
print(np.min(august_temps))
print(np.max(august_temps))

#3 and 4
print("Which city had the greatest range of temperatures in August (max - min)? What was it?")
...
range_list = [paris_range, helsinki_range, copenhagen_range, rome_range, madrid_range, stockholm_range, london_range]
biggest_range = 0
...
print("Which city had the smallest range of temperatures in August (max - min)? What was it?")
range_list = [paris_range, helsinki_range, copenhagen_range, rome_range, madrid_range, stockholm_range, london_range]
smallest_range = 100
for range in range_list:
...
#5
print("Output an array with the daily average temperature of the 7 cities for the month. The resulting array should have 31 elements in it, one for each day, with each data point representing the mean of the 7 daily temperatures for that day.")
ave_daily = np.average(august_temps, axis=0) [0:30]
print(ave_daily)
...
rome_temperature_categories = rome
my_list = []
for temp in rome:
    if temp >=80:
      rome_temperature_categories = "Hot"
    elif temp >=70 and temp <80:
      rome_temperature_categories = "Warm"
    elif temp <=60 and temp <70:
      rome_temperature_categories = "Cool"  
    elif temp <60:
      rome_temperature_categories = "Cold"
    my_list.append(rome_temperature_categories)
...
# Write code below. 
day1 = np.array(rome[0:29])
day2 = np.array(rome[1:30])
rome_daily_deltas = day1-day2

# Print your output array below
print(rome_daily_deltas)
...
new_result = rome_daily_deltas
new_list = []
for num in rome_daily_deltas:
    if num >= 7:
    ...
    rome_daily_deltas_categories = np.array(new_list)
print(rome_daily_deltas_categories)
...
print("Histogram of Rome temperature categories")
rome_temperature_categories_histogram = create_histogram(my_array)
print(rome_temperature_categories_histogram)

print("Histogram of Rome temperature deltas")
rome_temperature_deltas_histogram = create_histogram(rome_daily_deltas)
print(rome_temperature_deltas_histogram)

print("Histogram of Rome temperature deltas categories")
rome_delta_categories_histogram = create_histogram(rome_daily_deltas_categories)
print(rome_delta_categories_histogram)